...
public class JPath1 extends BeakAutonCommand {
    ...
    public JPath1(Vision vision, BeakDrivetrain drivetrain) {
        super.addCommands(
                ...
                new InstantCommand(() -> SmartDashboard.putNumber("Theta error", m_poseDiff.getRotation().getDegrees())),
                new RotateDrivetrainToAngle(() -> m_desiredAprTagPose.getRotation(), drivetrain, false) // verify the angle 
            );
