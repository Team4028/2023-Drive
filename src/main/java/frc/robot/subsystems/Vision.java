...
public class Vision extends SubsystemBase {
    ...
    public Pose2d getScoringPosition(Pose2d robotPose) {
        PhotonTrackedTarget target = getBestTarget();
        
        if (target != null) {
            Transform3d cameraToTarget = target.getBestCameraToTarget();

            Transform3d targetOffset = cameraToTarget.plus(new Transform3d(new Pose3d(), new Pose3d(1/6, 0, 0, new Rotation3d())));
