...
/** Add your docs here. */
public class EpicOctavianSwerveDrivetrain extends BeakEpicSwerveDrivetrain {
    private static EpicOctavianSwerveDrivetrain m_instance;
    ...
    public static EpicOctavianSwerveDrivetrain getInstance() {
        if (m_instance == null) {
            m_instance = new EpicOctavianSwerveDrivetrain();
        }
        return m_instance;
    }
}
